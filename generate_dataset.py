...
DATASETS = {
    ...
    "divisibility_chain_small": {"bases": [2, 3], "length": 6, "n_quiz": 20, "n_negatives": 8, "stream_seed": 42, "quiz_seed": 99},
    "divisibility_chain_large": {"bases": [2, 3, 5, 7], "length": 12, "n_quiz": 100, "n_negatives": 40, "stream_seed": 42, "quiz_seed": 99},
}
